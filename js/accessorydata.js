...
// Базовые подсобки на каждое основное движение (подставляются в шаблоны и новые упражнения).
export const ACC_DEFAULTS = {
  squat:    [{ name: "Фронтальный присед", sets: 3, reps: 8 }, { name: "Гиперэкстензии", sets: 3, reps: 12 }],
  bench:    [{ name: "Жим узким хватом", sets: 3, reps: 8 }, { name: "Отжимания на брусьях", sets: 3, reps: 10 }],
  deadlift: [{ name: "Румынская тяга", sets: 3, reps: 8 }, { name: "Тяга в наклоне", sets: 3, reps: 10 }],
};
